...
object PrimitiveSet {
  ...
  private def addEntryToMap[P](fullPrimitive: Option[P],
                               primitive: Option[P],
                               key: Keyset.Key,
                               primitives: scala.collection.concurrent.Map[PrimitiveSet.Prefix, List[PrimitiveSet.Entry[P]]]) = {
  ...
  class Builder[P] private[PrimitiveSet](private val primitiveClass: Class[P]) {
    ...
    // anymore.
    private var primitives = new ConcurrentHashMap[PrimitiveSet.Prefix, List[PrimitiveSet.Entry[P]]]().asScala
 ...
 * */
final class PrimitiveSet[P] (private val primitives: collection.concurrent.Map[PrimitiveSet.Prefix, List[PrimitiveSet.Entry[P]]],
